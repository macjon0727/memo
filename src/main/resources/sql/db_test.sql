...
insert into major values ('m1', '스프링', '이원재');
select * from major;

insert into major values ('m2', '노드', '조병진');
insert into major values ('m3', '플라스크', '강민준');
insert into major values ('m4', '루비온레일즈', '윤성준');
insert into major values ('m5', '라라벨', '류강희');
insert into major values ('m6', '리액트', '윤민재');
insert into major values ('m7', '뷰', '이예진');
insert into major values ('m8', '앵귤러', '김호준');

desc student;

insert into student values('s1','최고다','20100101', 'M','01001010101','m1');
select * from student;
...
insert into student(student_code, name, gender, major_code, birth, phone) values ('s12', '정오빈', 'M', 'm3','20030202','0103333333');
...
INSERT INTO STUDENT(student_code, name, gender, major_code, birth, phone) VALUES('s14', '김동현', 'M', 'm4', '20030202', '01000000020'),
                                                                                ('s15', '박은진', 'F', 'm3', '01000040', '01042312441');
...
select * from student;
insert into student values ('s0', '안될애','20202020','M','01052234234','m1');

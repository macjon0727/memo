...
insert into student
values ('s1', '최원빈', '20100101', 'M', '01001010101', 'm1');
INSERT INTO STUDENT
VALUES ('s2', '강준규', '20220501', 'M', '01000000002', 'm1')
     , ('s3', '김영철', '20220711', 'M', '01000000003', 'm1');
INSERT INTO STUDENT
VALUES ('s4', '예상기', '20220408', 'M', '01000000004', 'm6'),
...
insert into student(student_code, name, gender, major_code, birth, phone)
values ('s12', '정오빈', 'M', 'm3', '20030202', '01000000020');



INSERT INTO STUDENT
VALUES ('s13', '김가은', '20220121', 'F', '01000000030', 'm1');
INSERT INTO STUDENT(student_code, name, gender, major_code, birth, phone)
VALUES ('s14', '김동현', 'M', 'm4', '20030202', '01000000020'),
       ('s15', '박은진', 'F', 'm3', '20221101', '01001010101');
INSERT INTO STUDENT(student_code, name, birth, gender, phone, major_code)
VALUES ('s16', '정영호', '20221105', 'M', '01000000050', 'm5');
INSERT INTO STUDENT(student_code, name, gender, major_code, birth, phone)
VALUES ('s17', '박가현', 'F', 'm7', '20030202', '01000000020');
INSERT INTO STUDENT(student_code, name, birth, gender, phone, major_code)
VALUES ('s18', '박용태', '20220508', 'M', '01000000060', 'm6');
INSERT INTO STUDENT
VALUES ('s19', '김예지', '20220505', 'F', '01000000070', 'm2');
INSERT INTO STUDENT
VALUES ('s20', '윤지용', '20220909', 'M', '01000000080', 'm3');
INSERT INTO STUDENT
VALUES ('s21', '손윤주', '20220303', 'F', '01000000090', 'm6');
...
insert into student
values ('s0', '안될애', '20202020', 'M', '01092922929', 'm1');
update student
set major_code = 'm2'
...
-- 데이터가 잘 들어갔는지, id가 자동으로 생성되었는지 확인
SELECT * FROM manager;

# 문제4. Join 으로 성적 가져오기
-- 명시적 조인(JOIN ~ ON)을 사용하여 세 테이블을 연결
...
-- 1-2. ON DELETE CASCADE 옵션을 추가하여 다시 생성
...
-- 2-2. ON DELETE CASCADE 옵션을 추가하여 다시 생성
...
-- 삭제 결과 확인
SELECT * FROM student WHERE student_code = 's1'; -- > 결과 없음
SELECT * FROM exam WHERE student_code = 's1';    -- > 결과 없음 (자동 삭제됨)
SELECT * FROM manager WHERE student_code = 's1'; -- > 결과 없음 (자동 삭제됨)